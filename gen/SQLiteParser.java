// Generated from C:/Users/dogas/IdeaProjects/TestProj/src/main/antlr4\SQLiteParser.g4 by ANTLR 4.9.1
...
public class SQLiteParser extends Parser {
    ...
    public static class Of_OF_fsetContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SQLiteParserVisitor)
                return ((SQLiteParserVisitor<? extends T>) visitor).visitOf_OF_fset(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Default_DEFAULT__valueContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_default_DEFAULT__value;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SQLiteParserListener)
                ((SQLiteParserListener) listener).enterDefault_DEFAULT__value(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SQLiteParserListener)
                ((SQLiteParserListener) listener).exitDefault_DEFAULT__value(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SQLiteParserVisitor)
                return ((SQLiteParserVisitor<? extends T>) visitor).visitDefault_DEFAULT__value(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Recursive__selectContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_recursive__select;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SQLiteParserListener)
                ((SQLiteParserListener) listener).enterRecursive__select(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SQLiteParserVisitor)
                return ((SQLiteParserVisitor<? extends T>) visitor).visitRecursive__select(this);
            else return visitor.visitChildren(this);
        }
    }
